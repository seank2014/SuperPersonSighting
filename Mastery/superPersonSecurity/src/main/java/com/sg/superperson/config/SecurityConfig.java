 ...
 */
package com.sg.superperson.config;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception{
      http
              ...
              .antMatchers("/", "/home", "/locations", "/orgs", "/sightings","/superPersons", "/superPowers",
                      "/superDetail", "/sightingDetail", "/signUp","/createSideKick").permitAll()
